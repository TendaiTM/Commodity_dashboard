            ...
            <div class="bg-white px-12 py-8 mb-8 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="submit">
                    ...
                    <div class="mb-4 grid grid-cols-3 gap-3">
                        ...
                        <input type="text" v-model="form.popularCommodity" id="popularCommodity" name="popularCommodity"
                            class="border rounded w-full py-2 px-3 mb-2" placeholder="Popular commodity" required>
                    </div>
                    <div>
                        <button
